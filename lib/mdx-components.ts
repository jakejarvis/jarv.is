...
export const Image = dynamic(() => import("../components/Image/Image"));
export const Figure = dynamic(() => import("../components/Figure/Figure"));
export const code = dynamic(() => import("../components/CodeBlock/CodeBlock"));

...
My humble abode on the World Wide Web, created and deployed using [Next.js](https://nextjs.org/), [Tailwind CSS](https://github.com/user-attachments/assets/dfe99976-c73d-46f1-8a50-f26338463ad8), [Supabase](https://supabase.com/), [Upstash](https://upstash.com/), [and more](https://jarv.is/humans.txt).

  ...
  return (
    <>
      ...
      <div className="prose prose-neutral dark:prose-invert prose-sm max-w-none">
        ...
        <h2>Comments</h2>
        <p>
          Post comments are similarly stored in a Postgres database. Authentication is provided via
          GitHub, from which the account&rsquo;s username, email, and avatar URL are stored.
        </p>

        <h2>Third-Party Content</h2>
        <p>
          Occasionally, embedded content from third-party services is included in posts, and some
          may contain tracking code that is outside of my control. Please refer to their privacy
        ...
        <p>
          ...
          and{" "}
          <a href="https://www.kasada.io/privacy-policy/" target="_blank" rel="noopener noreferrer">
            Kasada&rsquo;s
          </a>{" "}
